...
execute if score .print_messages item_structures matches 1 run title @s title {"text":"Item Imported","color":"dark_green"}
execute if score .print_messages item_structures matches 1 run title @s subtitle {"text":"Imported from hand Item","color":"gray"}
