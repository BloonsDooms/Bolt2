...
data modify storage bs:data load.modules append value {module:"bs.block",version:"3.0.2",enabled:0b}
...
execute if score $bs.block.major load.status matches 3 if score $bs.block.minor load.status matches 0 unless score $bs.block.patch load.status matches ..2 run return 0
scoreboard players set $bs.block.major load.status 3
scoreboard players set $bs.block.minor load.status 0
scoreboard players set $bs.block.patch load.status 2
