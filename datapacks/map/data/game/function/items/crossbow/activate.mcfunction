...
item replace entity @s weapon.mainhand with crossbow[custom_name={"text":"Crossbow [Active]","italic":false,"color":"gray"},unbreakable={},custom_data={trigger:0b},charged_projectiles=[{id:"minecraft:arrow",count:1}]] 1
