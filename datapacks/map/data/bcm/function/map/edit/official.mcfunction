...
# ## generators
# data modify storage bcm map.tmp_generators set from storage maps:active gens
...
# data modify storage bcm macro.origin set from storage bcm spawn.redSpawnBoundingBox[0].origin
...
# data modify storage bcm macro.origin set from storage maps:active spawn.blueSpawnBoundingBox[0].origin
